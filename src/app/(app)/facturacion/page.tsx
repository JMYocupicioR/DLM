  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="font-headline text-xl font-bold mb-6">Facturación</h1>
        {/* CFDI Alert */}
        {pendingCFDI.length > 0 && !profile?.rfc && (
          <Card className="mb-6 border-amber-500/40 bg-amber-500/10">
            <CardContent className="p-4 flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-amber-900 dark:text-amber-200">Solicita tu factura CFDI</p>
